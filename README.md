...
[araea/note-watermark · 实验视觉分支](https://github.com/araea/note-watermark/tree/feat/nothing-inspired-ui)。3.3.1 更新设置界面和启动图标，功能与设置保持不变；使用开放授权的 Doto 字体，无 Nothing 专有资产。
